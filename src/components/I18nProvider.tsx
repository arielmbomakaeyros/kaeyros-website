...
export default function I18nProvider({ children }: I18nProviderProps) {
  ...
  if (!messages) {
    return (
      <div className="flex h-screen flex-col items-center justify-center bg-slate-50">
        <h1 className="mb-8 text-3xl text-center font-bold text-slate-800">
  ...
  return (
    ...
    >
      <Header onLocaleChange={changeLocale} />
      {children}
    </NextIntlClientProvider>
  );
}
...
//     return (
//       <div className="flex h-screen flex-col items-center justify-center bg-slate-50">
//         <h1 className="mb-8 text-3xl font-bold text-center text-slate-800">
//           Welcome to Kaeyros-Analytics website
//         </h1>
//         <div className="relative flex flex-col items-center">
//           <div className="h-[200px] w-[200px] animate-spin rounded-full border-4 border-slate-200 border-t-blue-500">
