    ...
    <section className="py-16 bg-[#FAFAFAD9]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <SmallSectionHeader label="Kaeyros Family" />
        ...
        {/* Rest of the family */}
        <div className="relative md:rounded-bl-[100px] lg:rounded-bl-[200px] mt-[3rem] md:rounded-tr-[100px] lg:rounded-tr-[200px] overflow-hidden shadow-lg sm:h-[300px] md:h-[400px] lg:h-[700px]">
          <img
