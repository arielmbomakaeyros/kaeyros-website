...
const solutionsData: SolutionData[] = [
  {
    ...
    imagePath: "/solutions/ucb.png",
    backgroundGradient: "from-pink-50 to-pink-100",
    borderRadius: "rounded-tr-[100px] rounded-bl-[100px]",
  },
  {
    id: "ease-travel",
    category: "Voyage",
    title: "Ease Travel",
    logo: <EaseSolutionSvg />,
    ...
    imagePath: "/solutions/k-shap.png",
  ...
  },
  {
    ...
    imagePath: "/solutions/anti-d.png",
    backgroundGradient: "from-orange-50 to-orange-100",
    hasMultipleLogos: true,
    additionalLogos: [
      <>
        <MiqSolutionSvg />
      </>,
...
export function SolutionsInSolutionSection() {
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 lg:px-8">
            ...
            <div key={solution.id} className="mx-auto ">
              <div className="relative rounded-3xl overflow-hidden">
                <div className="relative h-[700px] z-10 grid lg:grid-cols-2 gap-8 p-2 lg:p-4 items-center">
                  ...
                  <div
                    className={`h-[80%] absolute right-0 w-[700px] bg-gradient-to-br ${
                      solution.backgroundGradient
                    } flex items-center ${
            ...
            <div key={solution.id} className="mx-auto ">
              <div className="relative rounded-3xl">
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 p-2 lg:p-4 items-center">
                  ...
                  <div
                    className={`order-1 lg:order-2 w-full h-[300px] sm:h-[400px] lg:h-[80%] bg-gradient-to-br ${
                      solution.backgroundGradient
                  ...
                  >
                    <div className="relative flex justify-center items-center w-full h-full">
                      <div className="w-full flex justify-center p-4 lg:pr-[3rem]">
                        <img
                          src={solution.imagePath}
                          alt={solution.title}
                          className="object-cover w-[70%] h-[70%] rounded-2xl"
        ...
        {/* <div className="flex justify-center mt-12">
          <Button className="bg-[#FF5F00] hover:bg-[#FF5F00]/90 py-[1.5rem] px-[3rem] text-white cursor-pointer transition-colors duration-200">
            Contactez nous
          </Button>
        </div> */}
      </div>
